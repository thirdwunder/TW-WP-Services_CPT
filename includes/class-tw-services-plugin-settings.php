...
class TW_Services_Plugin_Settings {

	/**
	 * The single instance of TW_Services_Plugin_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'tw-services-plugin' ) . '</a>';
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'tw-services-plugin' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
	...
	/**
	 * Main TW_Services_Plugin_Settings Instance
	 *
	 * Ensures only one instance of TW_Services_Plugin_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see TW_Services_Plugin()
	 * @return Main TW_Services_Plugin_Settings instance
	 */
